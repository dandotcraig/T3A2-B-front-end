...
export default function EditInvoiceModal({ onClose, invoiceId }) {
    ...
    // PHASE TWO: Edit LINE ITEM AND SEND TO DB
                                    ...
                                    <div className="flex justify-between ">
                                        <div className="flex flex-col w-full gap-2">
                                            <div className="flex justify-between flex-row w-full">
                                                <CardTitle className="flex-grow">Edit invoice</CardTitle>
                                ...
                                <CardContent className="flex flex-row gap-8">
                                    <form className="w-full">
                                        <div className="grid items-center gap-4">
                                            ...
                                            <div className='mt-4'>
                                                <Button className="w-full items-center" onClick={handleEditLineItem} disabled={loading}>{loading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : 'Edit line item'}</Button>
